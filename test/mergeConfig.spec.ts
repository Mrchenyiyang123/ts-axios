...
describe('mergeConfig', () => {
  ...
  test('should allow setting request optings', () => {
    const config = {
      url: '__sample url__',
  ...
  test('should not inherit request optings', () => {
    const localDefautls = {
      url: '__sample url__',
      params: '__sample params__',
      data: { foo: true }
    ...
    const merged = mergeConfig(localDefautls, {})
  ...
  test('should overwite auth, headers with a non-object value', () => {
    expect(
      mergeConfig(
        {
          headers: {
