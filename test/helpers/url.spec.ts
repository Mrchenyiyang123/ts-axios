...
describe('helpers:url', () => {
  ...
  describe('isAbsoluteURL', () => {
    test('should return true if URL begin with valid scheme naem', () => {
      expect(isAbsoluteURL('https://api.github.com/users')).toBeTruthy()
      expect(isAbsoluteURL('custom-scheme-v1.0://example.com/')).toBeTruthy()
      expect(isAbsoluteURL('HTTP://example.com/')).toBeTruthy()
    })

    test('should return false if URL begin with invaild scheme name', () => {
  ...
  describe('combineURL', () => {
    ...
    test('should not insert slash whrn relative url missing/emplt', () => {
      expect(combineURL('https://api.github.com/users', '')).toBe('https://api.github.com/users')
    })
  ...
  describe('isURLSameOrigin', () => {
    ...
    test('should detect different origin', () => {
      expect(isURLSameOrigin('https://github.com/axios/asios')).toBeFalsy()
    })
  })
})
