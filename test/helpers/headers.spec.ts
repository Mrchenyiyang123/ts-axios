...
describe('helpers:headers', () => {
  ...
  describe('processHeaders', () => {
    ...
    test('should set Content-Type if not set and is PlainObject', () => {
      const headers: any = {}
  ...
  describe('flattenHeaders', () => {
    test('should flatten the headers and inclind common headers', () => {
      const headers = {
    ...
    test('should flatten thr headers without common headers', () => {
      const headers = {
        Accept: 'application/json',
        get: {
          'X-GET-HEADER': 'getHeaderValue'
